...
#636363
#252525
###Need to adjust colorramp and  Clim2$Color designations based on dataset###

Colorramp<-c('#f7f7f7','#d9d9d9','#bdbdbd','#969696','#636363','#252525','red')
# Colorramp<-c("#ffffff","#e0dede","#c6c2c2","#969494","#6d6d6d", "#494949", "brown")

setwd("C:/Users/achildress/Documents/Data_Visualization/Visualization-HV/Visualization/")
Centroids<-read.csv("Data_Visualization/nps_boundary_centroids/NPS_Centroid_Test2.csv",header=T)
